...
/*
			...
			{
				output.led_s[2]=0;
				output.direction_bend_m=0; //slave going forward, master going back
				output.direction_bend_s=1;
...
/*			
			...
			if((input.switch_tension_m==1)&(input.switch_dock_s==0)) {
				output.speed_bend_m=60;
				}
			else {
				output.speed_bend_m=0;
				}
			if((input.switch_tension_s==1)&(input.switch_dock_s==0)) {
