...
//			printf("m x=%d y=%d \n\r",input.accell_m[0],input.accell_m[1]);
//			printf("s x=%d y=%d \n\r",input.accell_s[0],input.accell_s[1]);
...
//// automatic attachment
			...
			if (count>20){
				...
				m_angle=atan2((input.accell_s[0]),(input.accell_s[1])); 
...
//					printf("%d %d \n\r", (int)m_angle, (int)get_accel_diff());
					s_angle=abs(atan2((input.accell_m[0]),(input.accell_m[1]))-m_angle);
//					if (abs(get_accel_diff()-m_angle)>20){  
					if ((s_angle>20) && (s_angle<100)) {
						toggle=1;
						}
					}
...
//					if (abs(get_accel_diff()-m_angle)>20){
		...
		case 7: //detaching the slave side
				...
				count++;
				if (toggle==0){
				s_angle=abs(atan2((input.accell_s[0]),(input.accell_s[1]))-m_angle);
//				printf("%d %d \n\r", (int)m_angle, (int)get_accel_diff());
//					if (abs(get_accel_diff()-m_angle)>20){
					if ((s_angle>20) && (s_angle<100)){
						toggle=1;
